...
// !! COPY THESE SOURCE CODE FROM HERE
// https://github.com/smartcontractkit/LinkToken/blob/master/contracts-flat/v0.7/LinkTokenChild.sol
    ...
    LinkToken
{
     ...
     */
    function _onCreate() internal override {}
    ...
    function mint(
        address recipient,
        uint256 amount
    ) public virtual override checkAccess {
    ...
    function burn(
        uint256 amount
    ) public virtual override(IERC20Child, ERC20Burnable) checkAccess {
        super.burn(amount);
    }
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal virtual override(ERC20, LinkToken) {
        super._transfer(sender, recipient, amount);
    }
